<script>
  ...
  <style>
    ...
    .card {
      position: absolute;
      aspect-ratio: 5/7;
      transition: transform 800ms cubic-bezier(.28, .93, .34, .85), opacity .4s, z-index .8s;
    ...
    #bulbasaur {
      background-image: url("https://www.serebii.net/card/pokemondetectivepikachu/1.jpg");
      background-position: center;
      background-size: cover;
    }
    ...
    #lugia {
      background-image: url("https://www.serebii.net/card/silvertempest/185.jpg");
      background-position: center;
      background-size: cover;
    }
    ...
    .card-group:hover > #mewtwo {
      transform: translate(-280%, -170%) rotate(15deg);
    }
  
    .card-group:hover > #lugia {

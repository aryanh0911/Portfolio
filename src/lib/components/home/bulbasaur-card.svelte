<script>
	...
	export let bulbasaurCardHovered = false;
</script>
...
<style>	
	#bulbasaur {
		...
		transition:
			...
			opacity 0.4s,
			z-index 0.8s;
		background-image: url('https://res.cloudinary.com/dyn3q57b8/image/upload/f_auto,q_auto/v1/My%20Portfolio%20(SvelteKit)%20May%202024/home-page/comp/pokemon-cards_comp/bulbasaur_comp');
